...
from arch_utils.unet_utils import Hook, CustomPixelShuffle_ICNR,  UnetBlockWide, NormType, custom_conv_layer
...
class DDColor(nn.Module):
    def __init__(
        ...
        self.encoder = ImageEncoder(['norm0', 'norm1', 'norm2', 'norm3'])
        self.encoder.eval()
...
class ImageEncoder(nn.Module):
    def __init__(self, hook_names):
        ...
        self.arch.load_state_dict(state_dict, strict=False)
...
if __name__ == '__main__':
    encoder = ImageEncoder(['norm0', 'norm1', 'norm2', 'norm3'])
